				...
				c.mixin(d.prototype, {
					...
					getSuggestions: function (a, b) {
						...
						a.length < this.minLength ||
							((e = c.tokenizeQuery(a)),
							(f = this._getLocalSuggestions(e).slice(
								0,
								this.limit
							)),
							f.length < this.limit &&
			...
			function b(a) {
				...
				c.bindAll(this),
					...
					(this.dropdownView = new k({ menu: b })
						...
						.on(
							'cursorMoved',
							this._setInputValueToSuggestionUnderCursor
						)
